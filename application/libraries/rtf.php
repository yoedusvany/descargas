...
class Rtf {
     ...
     * @return		void
     */
    function config_margin($orientation = "v", $margl = 720, $margr = 720, $margt = 720, $margb = 720) {
        if($orientation == "v"){
            $this->MyRTF .= "\\paperw12240\\paperh15840\n";
        }else
            $this->MyRTF .= "\\paperw15840\\paperh12240\n";
